# I got this from lobe on May02, 2021.
# To adjust model file path, a minor modification was made
# around line 30.
# renamed the file to my_tflite_example.py
